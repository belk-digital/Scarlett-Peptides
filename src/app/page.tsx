...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Shop curated research peptides with ≥99% HPLC purity, LC-MS identity verification, and batch-specific Certificates of Analysis. BPC-157, GHK-Cu, Retatrutide, NAD+, and more. Fulfilled by 99 Purity Peptides.",
  path: "",
  keywords: [
    "research peptides",
    "buy peptides online",
