...
const QUALITY_TAB: Tab = {
  ...
  paragraphs: [
    "Every compound in the Scarlett Hawkins catalog — including this product — is tested by an independent, US-based third-party laboratory prior to release. Testing is never conducted by the manufacturer or any commercially affiliated entity.",
...
export const products: Product[] = [
    ...
    tabs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Because GLOW is a blend, it is best suited to exploratory and combinatorial research designs. Researchers requiring strict single-compound dose-response data should consider Scarlett Hawkins' individual compounds (such as GHK-Cu) instead.",
        ],
      },
      QUALITY_TAB,
      COMPLIANCE_TAB,
    ...
    tabs: [
      {
        title: "Product Details",
        paragraphs: [
          "KLOW is supplied as a lyophilized powder in a sealed glass vial with a unique batch number tied to its own Certificate of Analysis. Packaging and cold-chain handling follow the same protocol used across the Scarlett Hawkins catalog.",
    ...
    tabs: [
      {
        title: "Product Details",
        paragraphs: [
          "Retatrutide is supplied as a lyophilized powder across 10mg, 20mg, 30mg, and 100mg vial sizes, each labeled with a unique batch number tied to its own Certificate of Analysis.",
          "Reconstitution should be performed with bacteriostatic water under standard aseptic technique, with concentration calculated according to your specific research protocol's dosing-curve requirements.",
          "Given the structural complexity of triple-agonist peptides, researchers should store reconstituted solutions refrigerated and protected from light, and avoid repeated freeze-thaw cycles which can degrade peptide integrity.",
        ],
      },
      {
        title: "Research Focus & Mechanism Overview",
        paragraphs: [
          "Retatrutide's defining feature is its simultaneous agonism at three incretin-related receptors — GLP-1, GIP, and glucagon — positioning it as a subject of interest for researchers comparing multi-receptor versus single-receptor metabolic intervention models.",
          "The glucagon receptor component distinguishes Retatrutide from dual GLP-1/GIP agonists, and is of particular interest in research examining energy expenditure and hepatic lipid metabolism pathways alongside appetite-regulation mechanisms.",
          "Its fatty-acid-modified structure is engineered for extended systemic half-life, making it relevant to pharmacokinetic research models examining sustained receptor engagement compared to earlier-generation incretin compounds.",
        ],
      },
      QUALITY_TAB,
      COMPLIANCE_TAB,
    ...
    faqs: [
      {
        ...
        a: "Retatrutide (LY3437943) is a triple-receptor agonist research peptide that activates GLP-1, GIP, and glucagon receptors simultaneously, studied extensively in metabolic and weight-regulation research models.",
      },
      {
        q: "How does Retatrutide differ from semaglutide or tirzepatide?",
        a: "Semaglutide is a single GLP-1 receptor agonist and tirzepatide is a dual GLP-1/GIP agonist. Retatrutide adds a third mechanism — glucagon receptor agonism — making it a triple agonist with a distinct pharmacological profile of research interest.",
      },
      {
        q: "What vial sizes does Retatrutide come in?",
        a: "Retatrutide is available in 10mg, 20mg, 30mg, and 100mg vials, with Single, 5-Kit, and 10-Kit options for most sizes.",
      },
      {
        q: "How is Retatrutide's purity verified?",
        a: "Each batch undergoes independent third-party HPLC purity testing and LC-MS identity confirmation, with results documented in a batch-specific Certificate of Analysis available to every buyer.",
      },
      {
        q: "How should Retatrutide be reconstituted and stored?",
        a: "Reconstitute with bacteriostatic water using standard aseptic technique. Store the lyophilized vial frozen or refrigerated away from light, and keep reconstituted solution refrigerated, avoiding repeated freeze-thaw cycles.",
      },
      {
        q: "Why is the glucagon receptor component significant in Retatrutide research?",
        a: "The glucagon receptor pathway is associated with increased energy expenditure and hepatic lipid metabolism in research models, offering a mechanism distinct from appetite suppression alone — a key reason Retatrutide is studied separately from dual agonists.",
      },
      {
        q: "Is Retatrutide approved for human use?",
        a: "No. Retatrutide is supplied strictly as a Research Use Only compound for laboratory and preclinical research. It is not approved by the FDA or any regulatory body for human or animal use.",
      },
      {
        q: "Can I retrieve the COA for my specific Retatrutide batch?",
        a: "Yes. Every vial carries a unique batch number that can be cross-referenced against the COA library for that batch's specific test results.",
      },
    ],
  },
  {
    ...
    tabs: [
      {
        ...
        paragraphs: [
          ...
          "Reconstitution should be performed with bacteriostatic or sterile water under standard aseptic technique, consistent with handling protocols across the Scarlett Hawkins catalog.",
        ],
      },
      {
        title: "Research Focus & Mechanism Overview",
  ...
  },
  {
    ...
    tabs: [
      {
        title: "Product Details",
        paragraphs: [
          "BPC-157 is supplied as a lyophilized powder in 10mg and 20mg vial sizes, each carrying a unique batch number tied to its own independently issued Certificate of Analysis.",
          "Reconstitution should be performed with bacteriostatic or sterile water under standard aseptic technique, consistent with protocols used across the Scarlett Hawkins catalog.",
          "As a relatively stable synthetic peptide, BPC-157 solutions are generally well-suited to refrigerated short-term storage, though freezer storage of the lyophilized form is recommended for longest-term integrity.",
        ],
      },
      {
        title: "Research Focus & Mechanism Overview",
        paragraphs: [
          "BPC-157 is studied for its reported ability to promote angiogenesis — the formation of new blood vessels — a mechanism considered central to its broad reparative effects across multiple tissue types in research models.",
          "Research has also examined BPC-157's interaction with the nitric oxide (NO) system, a pathway implicated in vascular function and tissue protection, alongside reported upregulation of growth factor expression including VEGF.",
          "BPC-157 is one of the most frequently studied peptides in tendon, ligament, and musculoskeletal repair research, often evaluated alongside or in comparison to TB-500 due to overlapping but mechanistically distinct reparative pathways.",
        ],
      },
      QUALITY_TAB,
      COMPLIANCE_TAB,
    ...
    faqs: [
      {
        q: "What is BPC-157?",
        a: "BPC-157 is a synthetic pentadecapeptide derived from a protective compound found in human gastric juice, studied extensively in preclinical research for its reported roles in tissue repair and angiogenesis.",
      },
      {
        q: "How does BPC-157 differ from TB-500?",
        a: "BPC-157 and TB-500 are mechanistically distinct: BPC-157 is studied primarily for angiogenesis and nitric oxide pathway modulation, while TB-500 (a Thymosin Beta-4 fragment) is studied for actin regulation and cell migration. Many research designs examine them separately to isolate each mechanism.",
      },
      {
        q: "What vial sizes are available for BPC-157?",
        a: "BPC-157 is available in 10mg and 20mg vials, each offered as a Single unit, 5-Kit, or 10-Kit.",
      },
      {
        q: "How is BPC-157 purity verified?",
        a: "Each batch is tested by an independent third-party laboratory via HPLC for purity quantification and LC-MS for identity confirmation, with results documented in a batch-specific Certificate of Analysis.",
      },
      {
        q: "How should BPC-157 be reconstituted and stored?",
        a: "Reconstitute with bacteriostatic or sterile water using standard aseptic technique. Store the lyophilized vial frozen or refrigerated away from light; reconstituted solution is generally suited to refrigerated short-term storage.",
      },
      {
        q: "Why is BPC-157 frequently referenced in tendon and ligament research?",
        a: "Its reported pro-angiogenic and growth-factor-modulating activity has made it a frequently studied compound in musculoskeletal repair models, particularly in research examining tendon and ligament tissue regeneration.",
      },
      {
        q: "Is BPC-157 approved for human use?",
        a: "No. BPC-157 is supplied strictly as a Research Use Only compound for in-vitro and preclinical laboratory research. It has not been evaluated by the FDA for human use.",
      },
      {
        q: "Can I retrieve the COA for my specific BPC-157 batch?",
        a: "Yes. Every vial is printed with a unique batch number that can be cross-referenced to retrieve that batch's specific Certificate of Analysis.",
      },
    ],
  },
  {
    ...
    tabs: [
      {
        title: "Product Details",
        paragraphs: [
          "KPV is supplied as a lyophilized powder in a sealed glass vial labeled with a unique batch number corresponding to its individual Certificate of Analysis.",
          "Reconstitution should be performed with bacteriostatic or sterile water under standard aseptic technique, consistent with handling protocols across the Scarlett Hawkins catalog.",
          "As a short tripeptide, KPV is relatively stable in lyophilized form when stored frozen and protected from light prior to reconstitution.",
        ],
      },
      {
        title: "Research Focus & Mechanism Overview",
        paragraphs: [
          "KPV is studied for its reported ability to inhibit NF-κB, a transcription factor central to the inflammatory response, making it a frequent subject of anti-inflammatory and immune signaling research.",
          "Unlike full-length α-MSH, KPV's anti-inflammatory activity has been reported in some research models to occur independently of melanocortin receptor binding, with evidence suggesting direct nuclear uptake as a contributing mechanism.",
          "KPV is also studied via the MC1R (melanocortin 1 receptor) pathway in select research models, alongside its receptor-independent mechanisms, making it a compound of interest for comparative inflammatory signaling research.",
        ],
      },
      QUALITY_TAB,
      COMPLIANCE_TAB,
    ...
    faqs: [
      {
        q: "What is KPV?",
        a: "KPV is the C-terminal tripeptide fragment of alpha-melanocyte-stimulating hormone (α-MSH), studied for its reported anti-inflammatory activity, particularly through inhibition of the NF-κB signaling pathway.",
      },
      {
        q: "How does KPV's mechanism differ from full α-MSH?",
        a: "While full-length α-MSH acts primarily through melanocortin receptor binding, KPV has been reported in some research models to exert anti-inflammatory effects independent of receptor binding, including via direct nuclear uptake.",
      },
      {
        q: "What is NF-κB and why does it matter for KPV research?",
        a: "NF-κB is a transcription factor that regulates genes involved in the inflammatory response. KPV's reported inhibition of NF-κB activation makes it a peptide of interest in anti-inflammatory and immune signaling research.",
      },
      {
        q: "How is KPV purity verified?",
        a: "Each batch is tested by an independent third-party laboratory using HPLC for purity quantification and LC-MS for molecular identity confirmation, with a Certificate of Analysis published per batch.",
      },
      {
        q: "How should KPV be reconstituted and stored?",
        a: "Reconstitute with bacteriostatic or sterile water using standard aseptic technique. Store the lyophilized vial frozen or refrigerated and protected from light prior to use.",
      },
      {
        q: "Is KPV related to MC1R research?",
        a: "Yes, KPV has been studied in connection with the melanocortin 1 receptor (MC1R) pathway in select research models, in addition to its receptor-independent anti-inflammatory mechanisms.",
      },
      {
        q: "Can I access the COA for my KPV batch?",
        a: "Yes. Every vial is labeled with a unique batch number corresponding to its own published Certificate of Analysis.",
      },
    ],
  },
  {
    ...
    tabs: [
      {
        title: "Product Details",
        paragraphs: [
          "TB-500 is supplied as a lyophilized powder in a dual 10mg/10mg vial configuration, labeled with a unique batch number corresponding to its individual Certificate of Analysis.",
          "Reconstitution should be performed with bacteriostatic or sterile water under standard aseptic technique, consistent with handling protocols across the Scarlett Hawkins catalog.",
          "As with other synthetic research peptides, the lyophilized form should be stored frozen and protected from light, with reconstituted solution kept refrigerated and used within your protocol's defined stability window.",
        ],
      },
      {
        title: "Research Focus & Mechanism Overview",
        paragraphs: [
          "TB-500 is studied for its reported ability to bind and sequester actin (G-actin), a mechanism associated with promoting cell migration, proliferation, and structural remodeling during tissue repair processes.",
          "Because actin dynamics are fundamental to wound contraction and cellular motility, TB-500 is frequently referenced in cardiac tissue repair, dermal wound-healing, and angiogenesis-adjacent research models.",
          "TB-500 is often studied alongside BPC-157 due to complementary, non-overlapping reparative mechanisms — actin regulation versus angiogenesis/NO pathway modulation — making the pair a common subject of comparative tissue repair research.",
        ],
      },
      QUALITY_TAB,
      COMPLIANCE_TAB,
    ...
    faqs: [
      {
        q: "What is TB-500?",
        a: "TB-500 is a synthetic peptide fragment of Thymosin Beta-4 (Ac-LKKTETQ), studied for its reported role in regulating actin and promoting cell migration and tissue repair in preclinical research models.",
      },
      {
        q: "How does TB-500 differ from BPC-157?",
        a: "TB-500's primary studied mechanism is actin sequestration affecting cell migration and structural remodeling, while BPC-157 is studied mainly for angiogenesis and nitric oxide pathway modulation. The two are often studied together for their complementary, non-overlapping repair mechanisms.",
      },
      {
        q: "Why is TB-500 studied in cardiac repair research?",
        a: "TB-500's reported influence on cell migration and actin dynamics has made it a peptide of interest in cardiac tissue repair models, where cellular motility and structural remodeling are central to recovery processes being studied.",
      },
      {
        q: "How is TB-500 purity verified?",
        a: "Each batch is tested by an independent third-party laboratory using HPLC for purity and LC-MS for molecular identity confirmation, with results published in a batch-specific Certificate of Analysis.",
      },
      {
        q: "How should TB-500 be reconstituted and stored?",
        a: "Reconstitute with bacteriostatic or sterile water using standard aseptic technique. Store the lyophilized vial frozen or refrigerated away from light, and refrigerate reconstituted solution, using it within your protocol's defined stability window.",
      },
      {
        q: "What does the '10/10mg' label mean?",
        a: "It indicates the vial configuration supplied — a 10mg fill that supports protocols typically structured around 10mg dosing increments, consistent with standard TB-500 research formats.",
      },
      {
        q: "Is TB-500 approved for human use?",
        a: "No. TB-500 is supplied strictly as a Research Use Only compound intended for in-vitro and preclinical laboratory research, not for human or veterinary use.",
      },
      {
        q: "Can I retrieve the COA for my specific TB-500 batch?",
        a: "Yes. Every vial carries a unique batch number that can be cross-referenced to retrieve that batch's specific Certificate of Analysis.",
      },
    ],
  },
];
